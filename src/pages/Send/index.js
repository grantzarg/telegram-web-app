    ...
    return (
        <Fragment>
            <div className={css.wrapper}>
                <div className={css.title}>Вывести</div>
                <div className={css.sendTypesWrapper}>
                    <div className={css.sendType}>
                        ...
                        <span>Вывести на карту или счет</span>
                    </div>
                    <div className={classnames(css.sendType, css.usdt)}>
