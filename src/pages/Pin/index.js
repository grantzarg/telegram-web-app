    ...
    return (
        <div className={css.wrapper}>
            <div className={css.inner}>
                ...
                {isValid ?
                    <div className={css.verifiedWrapper}>
                        <div className={css.iconWrapper}>
                            <div className={css.loaderWrapper}>
                                <div className={css.profileMainLoader}>
                                    <div className={css.loader}>
                                        <svg className={css.circularLoader} viewBox="25 25 50 50">
                                            <circle className={css.loaderPath} cx="50" cy="50" r="20" fill="none"
                                                    stroke="#7BC26F" stroke-width="2"/>
                                        </svg>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <svg className={css.successIcon} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill="#7BC26F" d="M512 64a448 448 0 1 1 0 896 448 448 0 0 1 0-896zm-55.808 536.384-99.52-99.584a38.4 38.4 0 1 0-54.336 54.336l126.72 126.72a38.272 38.272 0 0 0 54.336 0l262.4-262.464a38.4 38.4 0 1 0-54.272-54.336L456.192 600.384z"></path></g></svg>
