        ...
        <Fragment>
            ...
            <div className={css.wrapper}>
                ...
                <div className={css.receiveTypesWrapper}>
                    <div className={css.receiveType} onClick={() => navigate('/receive-bank')}>
                    ...
                    <div className={classnames(css.receiveType, css.usdt)} onClick={() => navigate('/receive-usdt')}>
                    ...
                    <div className={css.receiveType} onClick={() => navigate('/receive-person')}>
