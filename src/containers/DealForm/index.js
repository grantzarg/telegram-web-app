...
const DealForm = ({deal, onChangeDeal, additionalFieldsOptions, onChangeSenderAdditionalField, onChangeReceiverAdditionalField, onCalculatePrice, onSendDeal, priceOptions}) => {
    ...
    const isCurrentStepValid = useMemo(() => {
        ...
        return isReceiverAdditionalFieldsValid();
    }, [activeStep, deal]);
                                ...
                                <Step key={label}>
                                    ...
                                    <StepContent>
                                        ...
                                        <div className={css.buttonsWrapper}>
                                            ...
                                            {isCurrentStepValid && <Button size="small" variant="contained" sx={{ borderRadius: 25, marginTop: '20px', padding: '10px 20px' }} onClick={handleNext}>
                                                {buttonText}
                                            </Button>}
                                        </div>
                                    </StepContent>
