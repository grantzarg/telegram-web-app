...
function Confirmation({ priceOptions }) {
  ...
  const getExchangeRate = () => {
    ...
    const clientExchangeRate = isInvertedExchangeRate
      ? 1 / priceOptions.clientExchangeRate
      : priceOptions.clientExchangeRate;
      ...
      <div className={css.container}>
        <div className={css.priceWrapper}>
          <div className={css.priceItem}>
            ...
            <div className={css.priceItemValue}>
              {sendCurrency}
              {' '}
              {sendAmount}
            </div>
